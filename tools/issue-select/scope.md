...
I have experience with Python, JavaScript/TypeScript, React, Node.js, Java, C++, and AWS, and I am comfortable working with Git/GitHub, APIs, backend systems, and web applications. I am especially interested in improving my open-source contribution workflow and AI-assisted software engineering skills. I prefer issues with a clearly bounded implementation or bug fix and enough repository context to test my changes.
